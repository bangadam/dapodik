...
class GetData
{
    ...
    public function checkNPSN($get)
    {
        ...
        $cutName = substr($nama, 0, 6);
        if (
            strpos(strtolower($cutName), 'sma') !== false ||
            strpos(strtolower($cutName), 'smk') !== false ||
            strpos(strtolower($cutName), 'sman') !== false ||
            strpos(strtolower($cutName), 'smkn') !== false ||
            strpos(strtolower($cutName), 'man') !== false ||
            strpos(strtolower($cutName), 'mas') !== false
        ) {
            //NPSN Sekolah
